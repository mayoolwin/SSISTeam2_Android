            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    for (int i = 0; i < listview1.getAdapter().getCount(); i++) {
                        ...
                        textViewItem = (TextView) listview1.getChildAt(i).findViewById(R.id.textView1);

                        keys[i] = textViewItem.getText().toString();


                        //***
                        textViewDesc = (TextView) listview1.getChildAt(i).findViewById(R.id.textView2);
                    ...
                    ArrayList<YDisburseDetailModel> discreAryList = new ArrayList<YDisburseDetailModel>();
